document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleFormInput(e) {
        ...
        if (!field || !contactForm || !contactForm.contains(field)) return;
        validateField(field);
    }
        ...
        if (isFormValid) {
            ...
            fetch(action, options)
                ...
                .then(function() {
                    ...
                    contactForm.reset();
                    fields.forEach(function(field) {
                        field.classList.remove('form-input-valid', 'form-input-error');
                    });
                })
                .catch(function() {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd7b509f0-83cb-4f63-839a-6f1d0b115bbe',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd7b509f0-83cb-4f63-839a-6f1d0b115bbe';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd7b509f0-83cb-4f63-839a-6f1d0b115bbe';
